...
public final class CheMC implements ModInitializer
{
	...
	public static final ChemistryItem TRIIRONTETRAOXIDE_IG = new ChemistryItem(new FabricItemSettings().group(ItemGroup.MISC), 2);
	public static final ChemistryItem TRIIRONTETRAOXIDE_DS = new ChemistryItem(new FabricItemSettings().group(ItemGroup.MISC), 4);
	public static final _PickaxeItem TRIIRONTETRAOXIDE_PX = new _PickaxeItem(CheMCMaterial.TRIIRONTETRAOXIDE, new FabricItemSettings().group(ItemGroup.TOOLS));
	public static final _AxeItem TRIIRONTETRAOXIDE_AX = new _AxeItem(CheMCMaterial.TRIIRONTETRAOXIDE, 9.5F, 0, new FabricItemSettings().group(ItemGroup.TOOLS));
	public static final _HoeItem TRIIRONTETRAOXIDE_HO = new _HoeItem(CheMCMaterial.TRIIRONTETRAOXIDE, 0.0F, new FabricItemSettings().group(ItemGroup.TOOLS));
	public static final _ShovelItem TRIIRONTETRAOXIDE_SV = new _ShovelItem(CheMCMaterial.TRIIRONTETRAOXIDE, new FabricItemSettings().group(ItemGroup.TOOLS));
	public static final _SwordItem TRIIRONTETRAOXIDE_SW = new _SwordItem(CheMCMaterial.TRIIRONTETRAOXIDE, new FabricItemSettings().group(ItemGroup.COMBAT));
	public static final _PickaxeItem COMPLETELY_RUSTED_IRON_PX = new _PickaxeItem(CheMCMaterial.COMPLETELY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS));
	public static final TarnishablePickaxeItem HEAVILY_RUSTED_IRON_PX = new TarnishablePickaxeItem(CheMCMaterial.HEAVILY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS),
			COMPLETELY_RUSTED_IRON_PX, 24000);
	public static final TarnishablePickaxeItem MODERATELY_RUSTED_IRON_PX = new TarnishablePickaxeItem(CheMCMaterial.MODERATELY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS),
			HEAVILY_RUSTED_IRON_PX, 32000);
	public static final TarnishablePickaxeItem MILDLY_RUSTED_IRON_PX = new TarnishablePickaxeItem(CheMCMaterial.MILDLY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS),
			MODERATELY_RUSTED_IRON_PX, 36000);
	public static final TarnishablePickaxeItem SLIGHTLY_RUSTED_IRON_PX = new TarnishablePickaxeItem(CheMCMaterial.SLIGHTLY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS),
			MILDLY_RUSTED_IRON_PX, 40000);
	public static final TarnishablePickaxeItem UNRUSTED_IRON_PX = new TarnishablePickaxeItem(CheMCMaterial.UNRUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS), SLIGHTLY_RUSTED_IRON_PX,
			44000);
	public static final _ShovelItem COMPLETELY_RUSTED_IRON_SV = new _ShovelItem(CheMCMaterial.COMPLETELY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS));
	public static final TarnishableShovelItem HEAVILY_RUSTED_IRON_SV = new TarnishableShovelItem(CheMCMaterial.HEAVILY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS),
			COMPLETELY_RUSTED_IRON_SV, 24000);
	public static final TarnishableShovelItem MODERATELY_RUSTED_IRON_SV = new TarnishableShovelItem(CheMCMaterial.MODERATELY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS),
			HEAVILY_RUSTED_IRON_SV, 32000);
	public static final TarnishableShovelItem MILDLY_RUSTED_IRON_SV = new TarnishableShovelItem(CheMCMaterial.MILDLY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS),
			MODERATELY_RUSTED_IRON_SV, 36000);
	public static final TarnishableShovelItem SLIGHTLY_RUSTED_IRON_SV = new TarnishableShovelItem(CheMCMaterial.SLIGHTLY_RUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS),
			MILDLY_RUSTED_IRON_SV, 40000);
	public static final TarnishableShovelItem UNRUSTED_IRON_SV = new TarnishableShovelItem(CheMCMaterial.UNRUSTED_IRON, new FabricItemSettings().group(ItemGroup.TOOLS), SLIGHTLY_RUSTED_IRON_SV,
			44000);
	public static final _AxeItem COMPLETELY_RUSTED_IRON_AX = new _AxeItem(CheMCMaterial.COMPLETELY_RUSTED_IRON, 8.5F, -0.1F, new FabricItemSettings().group(ItemGroup.TOOLS));
	public static final TarnishableAxeItem HEAVILY_RUSTED_IRON_AX = new TarnishableAxeItem(CheMCMaterial.HEAVILY_RUSTED_IRON, 8.6F, -0.08F, new FabricItemSettings().group(ItemGroup.TOOLS),
			COMPLETELY_RUSTED_IRON_AX, 32000);
	public static final TarnishableAxeItem MODERATELY_RUSTED_IRON_AX = new TarnishableAxeItem(CheMCMaterial.MODERATELY_RUSTED_IRON, 8.7F, -0.06F, new FabricItemSettings().group(ItemGroup.TOOLS),
			HEAVILY_RUSTED_IRON_AX, 36000);
	public static final TarnishableAxeItem MILDLY_RUSTED_IRON_AX = new TarnishableAxeItem(CheMCMaterial.MILDLY_RUSTED_IRON, 8.8F, -0.04F, new FabricItemSettings().group(ItemGroup.TOOLS),
			MODERATELY_RUSTED_IRON_AX, 42000);
	public static final TarnishableAxeItem SLIGHTLY_RUSTED_IRON_AX = new TarnishableAxeItem(CheMCMaterial.SLIGHTLY_RUSTED_IRON, 8.9F, -0.02F, new FabricItemSettings().group(ItemGroup.TOOLS),
			MILDLY_RUSTED_IRON_AX, 45000);
	public static final TarnishableAxeItem UNRUSTED_IRON_AX = new TarnishableAxeItem(CheMCMaterial.UNRUSTED_IRON, 9.0F, 0, new FabricItemSettings().group(ItemGroup.TOOLS), SLIGHTLY_RUSTED_IRON_AX,
			48000);
	public static final _HoeItem COMPLETELY_RUSTED_IRON_HO = new _HoeItem(CheMCMaterial.COMPLETELY_RUSTED_IRON, -1.0F, new FabricItemSettings().group(ItemGroup.TOOLS));
	public static final TarnishableHoeItem HEAVILY_RUSTED_IRON_HO = new TarnishableHoeItem(CheMCMaterial.HEAVILY_RUSTED_IRON, -1.0F, new FabricItemSettings().group(ItemGroup.TOOLS),
			COMPLETELY_RUSTED_IRON_HO, 20000);
	public static final TarnishableHoeItem MODERATELY_RUSTED_IRON_HO = new TarnishableHoeItem(CheMCMaterial.MODERATELY_RUSTED_IRON, -1.0F, new FabricItemSettings().group(ItemGroup.TOOLS),
			HEAVILY_RUSTED_IRON_HO, 26000);
	public static final TarnishableHoeItem MILDLY_RUSTED_IRON_HO = new TarnishableHoeItem(CheMCMaterial.MILDLY_RUSTED_IRON, -1.0F, new FabricItemSettings().group(ItemGroup.TOOLS),
			MODERATELY_RUSTED_IRON_HO, 32000);
	public static final TarnishableHoeItem SLIGHTLY_RUSTED_IRON_HO = new TarnishableHoeItem(CheMCMaterial.SLIGHTLY_RUSTED_IRON, -1.0F, new FabricItemSettings().group(ItemGroup.TOOLS),
			MILDLY_RUSTED_IRON_HO, 36000);
	public static final TarnishableHoeItem UNRUSTED_IRON_HO = new TarnishableHoeItem(CheMCMaterial.UNRUSTED_IRON, -1.0F, new FabricItemSettings().group(ItemGroup.TOOLS), SLIGHTLY_RUSTED_IRON_HO,
			40000);
	...
	public static PlacedFeature GOETHITE_SO_PF = new PlacedFeature(RegistryEntry.of(GOETHITE_SO_CF), Arrays.asList(CountPlacementModifier.of(18), // number of veins per chunk
	...
	public static ConfiguredFeature<?, ?> GOETHITE_DO_CF = new ConfiguredFeature(Feature.ORE,
			new OreFeatureConfig(OreConfiguredFeatures.DEEPSLATE_ORE_REPLACEABLES, DEEPSLATE_GOETHITE.getDefaultState(), 7/*vein size*/));
	public static PlacedFeature GOETHITE_DO_PF = new PlacedFeature(RegistryEntry.of(GOETHITE_DO_CF), Arrays.asList(CountPlacementModifier.of(18), // number of veins per chunk
			SquarePlacementModifier.of(), // spreading horizontally
			HeightRangePlacementModifier.trapezoid(YOffset.getBottom(), YOffset.getTop()))); // height
	public static final BlastFurnaceBlock BLAST_FURNACE = new BlastFurnaceBlock(AbstractBlock.Settings.of(Material.STONE, MapColor.GRAY));
